package com.gchristov.personal.common.networktestfixtures
...
class FakeHttpResponse : HttpResponse {
    ...
    override fun sendFile(localPath: String) { lastFilePath = localPath }
    override fun setHeader(header: String, value: String) { lastHeader = header; lastHeaderValue = value }
